...
<div class="row mt-5 mb-5">
    <div class="col-lg-12 margin-tb">
        <div class="float-left">
            <h2>Create New Pegawai</h2>
        </div>
        <div class="float-right">
            <a class="btn btn-secondary" href="{{ route('pegawa.index') }}"> Kembali</a>
        </div>
    </div>
</div>
...
<form action="{{ route('pegawa.store') }}" method="POST">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Umur:</strong>
                <input type="number" name="pegawai_umur" class="form-control" placeholder="Umur">
            </div>
        </div>
